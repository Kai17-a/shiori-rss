...
from api.model.models import GitHubRepositoryCreate, GitHubRepositoryListResponse, GitHubRepositoryResponse, GitHubRepositoryUpdate
...
@router.patch("/{repository_id}", response_model=GitHubRepositoryResponse)
def update_github_repository(repository_id: int, body: GitHubRepositoryUpdate, service: GitHubRepositoryService = Depends(get_github_repository_service)):
    return service.update(repository_id, body)
